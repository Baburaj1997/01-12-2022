...
public class ActorGenreMovieController  {
	...
	public void run() {
		...
		Actor a1 = new Actor("Hrithik","Roshan",1974,null);
		Actor a2 = new Actor("Priyanka","Chopra",1996,null);
		...
		Movie m1 = new Movie("Agneepath",2012 ,null,g1);
		Movie m2 = new Movie("Arya 2",2009 ,null,g2);
		...
		System.out.println("\n\n Searching Actor records by name : \n ");
		Actor actor1 = actorRepository.findByName("Hrithik");
		...
		System.out.println("\n\n Searching Movie records by title : \n ");
		Movie movie1 = movieRepository.findByTitle("Arya 2");
